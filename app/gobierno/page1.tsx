...
export default function Page() {
  return (
    <>
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-6 text-sm text-gray-700">
          <div className="card">
            ...
            <p className="mt-2">
              Dominios oficiales, buzones seguros y retenciones para transparencia
          ...
          <div className="card">
            ...
            <p className="mt-2">
              Teams, SharePoint y OneDrive para reuniones, coautoría y gestión
              documental con control de acceso.
            </p>
          </div>
          <div className="card">
            <h3 className="font-semibold">Seguridad y cumplimiento</h3>
            <p className="mt-2">
              MFA, acceso condicional, auditoría, DLP y retenciones para cumplir
      ...
      {/* PLANES */}
      <Section
        title="Planes recomendados para gobierno"
        subtitle="Planes diseñados según nivel de productividad, seguridad y cumplimiento requerido."
      >
        <PricingTable
          tiers={[
            {
        ...
        <p className="text-xs mt-3 text-gray-500">
          * La disponibilidad puede variar por contrato y configuración. Validamos
          cada caso en la propuesta formal.
        </p>
      </Section>

      {/* SEGURIDAD Y CUMPLIMIENTO */}
      <Section
        title="Seguridad, cumplimiento y gobernanza de datos"
        subtitle="Buenas prácticas aplicadas en entornos gubernamentales."
      >
        <ul className="grid md:grid-cols-2 gap-4 text-sm text-gray-700 list-disc pl-5">
          <li>Autenticación multifactor (MFA) y acceso condicional.</li>
          ...
          <li>Protección anti-phishing y malware.</li>
          <li>Gestión de dispositivos con cifrado, parches y contraseñas seguras.</li>
        </ul>
      </Section>
      ...
      <Section title="Metodología de implementación">
        <ol className="grid gap-3 list-decimal pl-6 text-sm text-gray-700">
          <li><strong>Descubrimiento:</strong> levantamiento de dominios, usuarios y dependencias.</li>
          <li><strong>Diseño:</strong> arquitectura de identidad, DNS, seguridad y gobernanza.</li>
          <li><strong>Pilotaje:</strong> validación de correo, Teams y políticas.</li>
          <li><strong>Migración:</strong> ejecución por lotes y comunicación a usuarios.</li>
          <li><strong>Adopción y soporte:</strong> capacitación, mesa de ayuda y optimización continua.</li>
        </ol>
      </Section>
          ...
          items={[
            {
              ...
              a: "Solicita cotización a SolutechCloud. Aceptamos órdenes de compra y entregamos licencias con facturación local en Panamá.",
            },
            {
              q: "¿Cuál es la diferencia entre E1, E3 y E5?",
              a: "E1: apps web básicas. E3: apps completas y seguridad estándar. E5: seguridad avanzada y telefonía.",
            },
            {
              q: "¿Incluyen migración y capacitación?",
              a: "Sí, cubrimos migración de correo/archivos y sesiones de adopción para usuarios y TI.",
            },
            {
              q: "¿Pueden respaldar datos de Microsoft 365?",
              a: "Sí, integramos backup para Exchange Online, OneDrive, SharePoint y Teams.",
            },
            {
              q: "¿Cuánto tarda la activación?",
              a: "Usualmente el mismo día hábil tras confirmación. La migración se agenda por lotes.",
            },
            {
              q: "¿Ofrecen soporte administrado?",
              a: "Sí, con mesa de ayuda, administración del tenant y reportes mensuales.",
            },
          ]}
        />
        <div className="mt-8 text-center">
          <h3 className="text-xl font-semibold">
            ¿Listo para llevar tu institución al siguiente nivel?
          </h3>
